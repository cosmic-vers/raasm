...
// Calendar-day key ("2026-10-24") in the venue's timezone, so day-based
// ticket validity is judged by the date at the door, not the server's UTC
// clock. Two dates are "the same event day" iff this returns the same string.
export function venueDateKey(date) {
